...
class TestEvalF1(unittest.TestCase):
    ...
    def test_evalF0_1(self):
        ...
        r = evalF0(1, self.z, 1)
        ref = np.array((
            1.5, 1.309016994374948, 0.809016994374947,  0.190983005625053,
            -0.309016994374947,  -0.5, -0.309016994374947,  0.190983005625052,
    ...
    def test_evalF0_2(self):
        ...
        ref = np.array((
            2.5, 2.118033988749895, 1.118033988749895, -0.118033988749895,
            -1.118033988749895, -1.5, -1.118033988749895, -0.118033988749895,
